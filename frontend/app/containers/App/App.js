...
import Root from "components/Guest/Root";
...
const App = () => (
    <Switch>
        ...
        <GuestRoute exact path="/" component={props => (<Root {...props}/>)}/>
        ...
        <PrivateRoute exact path="/settings" component={props => (<PrivatePage {...props} component={<Settings/>}/>)}/>
