...
class AccountForm extends React.Component {
    ...
    render() {
        const {t} = this.props;
        const {account, urlError, nameError, serverError, handleChange} = this.props;
        return (
            <React.Fragment>
                <TextInput id="url" label={t('personalAccounts.modal.form.url')} error={urlError}
                ...
                <Row>
                    <Col md={6}>
                        <TextInput id="username" label={t('personalAccounts.modal.form.username')}
                ...
                <TextArea id="description" label={t('personalAccounts.modal.form.description')}
